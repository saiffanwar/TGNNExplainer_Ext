...
for method in "tgnnexplainer" "sa" "temp_me"
do
    python3.12 ~/PhD/TGNNExplainer_Ext/benchmarks/explainer_run/run.py datasets=${dataset} device_id=0 explainers=${method} models=${model} results_batch=${2}
done
